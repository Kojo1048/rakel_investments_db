...
import { Building2, ChevronRight, FolderOpen, Search, AlertCircle } from 'lucide-react';
...
export default function SuperAdminDocumentsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Documents</h1>
        <p className="text-muted-foreground">Select a company to view its uploaded documents.</p>
      </div>
