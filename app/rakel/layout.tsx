...
const ALLOWED = ['RAKEL_ADMIN', 'SUPER_ADMIN'];

export default function RakelLayout({ children }: { children: React.ReactNode }) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pl-64 flex flex-col min-h-screen">
        <header className="sticky top-0 z-10 h-12 flex items-center justify-end gap-3 px-6 border-b border-border bg-background">
          <span className="text-xs text-muted-foreground">Rakel Admin</span>
          <NotificationBell />
        </header>
